...
(function() {
            ...
            fire: function() {
                ...
                return function(i, j, n) {
                    ...
                    if (g) {
                        var r = g.listeners;
                        if (r.length)
                            for (var r = r.slice(0), y, o = 0; o < r.length; o++) {
                                if (g.errorProof) try {
                                    y =
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {
        ...
        getPosition: function(a) {
            ...
            for (var d = this.getAddress(), a = a.getAddress(),
                    b = Math.min(d.length, a.length), c = 0; c < b; c++)
            ...
            removeStyle: function(a) {
                ...
                if (!b.removeProperty && (a == "border" || a == "margin" || a == "padding")) {
                    ...
                    for (var b = [], d = 0; d < c.length; d++)
                        if (g)
                            for (var r = 0; r < g.length; r++) b.push([a, c[d], g[r]].join("-"));
    ...
    (function() {
        function a(a, b) {
            ...
            if (this.current) g = this.current[s](false, l, h);
            else {
                if (a) g.type ==
        ...
        function d(a, b, c, d, o) {
            ...
            function h() {
                ...
                if (b < D - 1 || b < G - 1 || c) {
                    ...
                    if (d)
                        if ((b = K[b + 1]) && b.type == CKEDITOR.NODE_ELEMENT) {
            ...
            if (l && k.type == CKEDITOR.NODE_TEXT && s.equals(k)) {
                ...
                if (k.type == CKEDITOR.NODE_TEXT) l ? u = true : k = k.split(F);
                ...
                if (s.type == CKEDITOR.NODE_TEXT) l ? E = true : s.split(m);
                ...
                for (N = x; N <= G; N++) {
                    c = C[N];
                    T = c.getPrevious();
                    if (c.equals(K[N])) b && (M = M.getChild(0));
                    else {
            ...
            enlarge: function(a, b) {
                ...
                switch (a) {
                    ...
                    case CKEDITOR.ENLARGE_ELEMENT:
                                    ...
                                    if (l.type == CKEDITOR.NODE_TEXT) {
                                        ...
                                        if (k && CKEDITOR.dtd.$removeEmpty[l.getName()]) {
                                            ...
                                            if (d.test(F)) l = null;
                                                ...
                                                for (var p = l.$.getElementsByTagName("*"), I = 0, z; z = p[I++];)
                        ...
                        if (m.type == CKEDITOR.NODE_TEXT)
                            if (CKEDITOR.tools.trim(m.substring(p)).length) k = true;
                            else {
                                k = !m.getLength();
                                if (p == m.getLength()) {
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        var E, u, K = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {
                                br: 1
                            } : null),
                            C = null,
                            x = function(a) {
        ...
        a.prototype = {
            getNextParagraph: function(a) {
                ...
                for (this._.nextNode = null; t;) {
                    ...
                    if (B) t.type == CKEDITOR.NODE_TEXT && e.test(t.getText()) &&
                        ...
                        if (CKEDITOR.dtd.$block[s] && t.getAttribute("contenteditable") == "false") {
                            ...
                            if (s == "br") B = 1;
                            else if (!h && !t.getChildCount() && s != "hr") {
                                d = t;
                                r = t.equals(q);
                                break
                            }
                ...
                if (!d) {
                    ...
                    d = d.block;
                    if (!d && t && !this.enforceRealBlocks && w[t.getName()] && h.checkStartOfBlock() && h.checkEndOfBlock() && !t.equals(h.root)) d = t;
        ...
        function y(a, b, k, e) {
            ...
            if (e.doFilter) {
                ...
                var g = b.attributes,
                    ...
                    x = b.styleBackup,
                    C, G, i = [];u = [];
                var I = /^data-cke-/;h = false;delete g.style;delete g["class"];delete b.classBackup;delete b.styleBackup;
                if (!a.allAttributes)
                    for (C in g)
                        if (!o[C])
                            if (I.test(C)) {
                ...
                h = function(b) {
                    a.call(this, b, function(a) {
                        ...
                        for (g in a) {
                            ...
                            if (!d[g]) {
                                if (i.icons)
                                    for (var y = i.icons.split(","), o = y.length; o--;) CKEDITOR.skin.addIcon(y[o], i.path + "icons/" + (CKEDITOR.env.hidpi && i.hidpi ? "hidpi/" : "") + y[o] + ".png");
                                d[g] = 1
                            }
                            if (r) {
                                r.split && (r = r.split(","));
                ...
                return function(e) {
                    if (e.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        var g = [],
                            ...
                            D, h;
                        if (p)
                            for (m(p, 1) && g.push(p); p;) {
                                if (f(p) && (D = c(p)) && m(D))
                                    if ((h = c(D)) && !f(h)) g.push(D);
                                    else {
                                        k(u).insertAfter(D);
                                        D.remove()
                                    }
                        ...
                        if (g = !a || (typeof d == "function" ? d(e) : d) !== false)
                            if (!u && !CKEDITOR.env.needsBrFiller &&
                                e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT) g = false;
                            else if (!u && !CKEDITOR.env.needsBrFiller && (document.documentMode > 7 || e.name in CKEDITOR.dtd.tr || e.name in CKEDITOR.dtd.$listItem)) g = false;
                        else {
                            g = b(e);
                    ...
                    if (b) {
                        ...
                        if (d = a.checkStartOfBlock())
                            if (d = a.checkEndOfBlock())
                                if (d = c.block)
                                    if (d = !a.root.equals(c.block)) {
                                        a: {
                                            var d =
                                                c.block.getElementsByTag("span"),
                                                g = 0,
                                                f;
                                            if (d)
                                                for (; f = d.getItem(g++);)
                        ...
                        this.attachListener(a, "key", function(b) {
                            ...
                            if (c in e) {
                                ...
                                if (CKEDITOR.env.ie && CKEDITOR.env.version < 11 && (g = b.getSelectedElement()) || (g = n(b))) {
                                    ...
                                    if ((m = h.block) && (l = m[c ? "getPrevious" : "getNext"](o)) && l.type == CKEDITOR.NODE_ELEMENT && l.is("table") && f[c ? "checkStartOfBlock" : "checkEndOfBlock"]()) {
                                        a.fire("saveSnapshot");
            ...
            B = function() {
                ...
                return function(l, x, s, G) {
                    ...
                    if (!G.checkReadOnly()) {
                        ...
                        for (;
                            (q = a(x.startContainer) && x.startContainer.getChild(x.startOffset - 1)) && a(q) && q.isBlockBoundary() && o.contains(q);) x.moveToPosition(q, CKEDITOR.POSITION_BEFORE_END);
                                ...
                                if (H = E.isLineBreak) {
                                    ...
                                    if (E.hasBlockSibling) H = 1;
                                        ...
                                        if (!Q || !Q.is({
                                            ...
                                            S = Q.getPosition(O);
                                            if (S == CKEDITOR.POSITION_IDENTICAL || S == CKEDITOR.POSITION_CONTAINS) H = 0;
                                            else {
                                                O = H.splitElement(Q);
                        ...
                        if (V)
                            for (; w = V.pop();) CKEDITOR.env.needsBrFiller ? w.appendBogus() : w.append(J.document.createText(" "));
                        ...
                        if (!l.dontMoveCaret) {
                            for (w = a(J.startContainer) && J.startContainer.getChild(J.startOffset - 1); w && a(w) && !w.is(h.$empty);) {
                                if (w.isBlockBoundary()) J.moveToPosition(w, CKEDITOR.POSITION_BEFORE_END);
                                else {
            ...
            return {
                list: {
                    detectMerge: function(a, b) {
                        ...
                        a.mergeList = f && h && f.getParent().equals(h.getParent()) &&
                            !f.equals(h);
    ...
    (function() {
        ...
        var y, o, q = CKEDITOR.dom.walker.invisible(1),
            t = function() {
                function a(b) {
                    return function(a) {
                ...
                for (m.getPosition(o) == CKEDITOR.POSITION_FOLLOWING && (m = 0); m;) {
                    ...
                    if (m.equals(o)) {
                        ...
                        if (q && j && CKEDITOR.dtd.$block[p])
                            for (var v = m, A = c(v), w = void 0, z = A.length, B = 0, v = z && new CKEDITOR.dom.range(v.getDocument()); B < z; ++B) {
                                var w = A[B],
                        ...
                        if (A)
                            if ((A = m.getParent()) && ((A.getDtd() || CKEDITOR.dtd.span)[g] || h) && (!f.parentRule || f.parentRule(A))) {
                                ...
                                if (p == CKEDITOR.NODE_TEXT || q || p == CKEDITOR.NODE_ELEMENT && !m.getChildCount()) {
                                    for (var p = m, S;
                                        (i = !p.getNext(I)) && (S = p.getParent(), k[S.getName()]) && (S.getPosition(n) | E) == E && (!f.childRule || f.childRule(S));) p = S;
                                    r.setEndAfter(p)
                                }
                            } else i = true;
                        else i = true;
                        ...
                        try {
                            ...
                            if (h) {
                                ...
                                if (!k.equals(a.editable()) && "html" !=
                                    k.getName()) o = k.getClientRect(), d < o.left ? f.setStartAt(k, CKEDITOR.POSITION_AFTER_START) : f.setStartAt(k, CKEDITOR.POSITION_BEFORE_END), f.collapse(!0);
